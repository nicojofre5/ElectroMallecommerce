...
<html lang="es">
  <head>
    ...
    <title>Forma de Pago - ElectroMall</title>
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-lg-8 text-left text-descript-centro-sobremi">
            ...
            <div class="contacto-container">
              ...
              >
               <div class="radio">
                <label><input type="radio" name="pago" id="tarjeta1">Tarjeta de credito 1 </label>
                <label><input type="radio" name="pago" id="tarjeta2">Tarjeta de credito 2 </label>
                <label><input type="radio" name="pago" id="tarjeta3">Tarjeta de debito </label>
                <label><input type="radio" name="pago" id="tarjeta4">Efectivo </label>
                <label><input type="radio" name="pago" id="tarjeta5">Transfernecia bancaria </label>
               </div>
                <div class="col-12">
